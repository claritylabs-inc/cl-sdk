...
| `form_inventory` | `FormReference[]` | Compatibility inventory of form references projected from source-tree form and endorsement nodes when available. Use `result.sourceTree` as the canonical form/section/schedule hierarchy. | Source tree | medium | — |
